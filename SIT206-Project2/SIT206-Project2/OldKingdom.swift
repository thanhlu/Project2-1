...
import UIKit
import MapKit
class OldKingdom: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let bsuCSCampusLocation:CLLocationCoordinate2D = CLLocationCoordinate2DMake(-37.824950, 145.097394)
        mapView.setRegion(MKCoordinateRegionMakeWithDistance(bsuCSCampusLocation, distanceSpan, distanceSpan),animated: true)
        let bsuCSClassPin = Mapkit(name: "Old Kingdom", rating: 3, coordinate: bsuCSCampusLocation)
