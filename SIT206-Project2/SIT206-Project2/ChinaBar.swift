...
import UIKit
import MapKit
class ChinaBar: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let bsuCSCampusLocation:CLLocationCoordinate2D = CLLocationCoordinate2DMake(-37.818055, 144.967902)
        mapView.setRegion(MKCoordinateRegionMakeWithDistance(bsuCSCampusLocation, distanceSpan, distanceSpan),animated: true)
        let bsuCSClassPin = Mapkit(name: "China Bar", rating: 3, coordinate: bsuCSCampusLocation)
